...
public class elevator extends SubsystemBase {
    ...
    public elevator() {
      m_elevatorMotor = new SparkMax(Constants.elevatorConstants.elevatorMotorID, MotorType.kBrushless);
      ...
      m_motorConfig.closedLoop
          ...
          .velocityFF(Constants.elevatorConstants.kFF)
      ...
      m_motorConfig.closedLoop.maxMotion
          ...
          .maxVelocity(Constants.elevatorConstants.kMaxMotionVelocity)
          .maxAcceleration(Constants.elevatorConstants.kMaxMotionAcceleration)
          .allowedClosedLoopError(1);
      try{
        m_elevatorMotor.configure(m_motorConfig,ResetMode.kNoResetSafeParameters,PersistMode.kPersistParameters);
        System.out.println("!!Successfully configured elevator motor!!");
      }
      catch (Exception e1){
        System.err.println("Failed to apply elevator motor configurations: "+e1.toString());
        DriverStation.reportWarning("Failed to apply elevator motor configuration",true);
      }
    ...
    public void runElevator(double setpoint){
